...
def add():
    watchlist_symbols = input("Enter the symbols you want to add separated by a space: ").split()
    watchlist_name = input("Enter the name of the new watchlist: ")
    watchlists[watchlist_name] = watchlist_symbols
    print(f"You added {added_symbols} to the {watchlist_name} watchlist.")
